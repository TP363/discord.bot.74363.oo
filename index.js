...
bot.on('ready', () => {
    ...
    bot.user.setActivity('Use $help Command to See The Commands Of This Bot!', { type: 'WATCHING' })
...
bot.login("ODE3MTQ4NjY3Nzg5MTgwOTMy.YEFTAA.xbOtM7l5o95s4jF9YyPxLWd8cKs");